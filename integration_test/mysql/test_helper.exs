...
defmodule Ecto.Integration.Mysql.AssignedPrimaryKey do
  use Ecto.Model
...
defmodule Ecto.Integration.Mysql.Case do
  ...
  setup do
    ...
    on_exit fn ->
      ...
      Mysql.query(TestRepo, "DROP TABLE migrations_test", [])
    end
...
setup_database = [
  "SELECT 1 = 1",
  "CREATE TABLE posts (id INT AUTO_INCREMENT, title varchar(100), text varchar (100), bin binary, PRIMARY KEY(id))",# (id serial PRIMARY KEY, title varchar(100), text varchar(100), tags text[], bin bytea, count integer)",
